...
public class Proj{
	...
	void testArray() {
		...
		Circle[] cArr = new Circle[5]; //creating of array of any object
...
//		List<Circle> l = new LinkedList<>();
//		List<Circle> l2 = new LinkedList<>();
...
//		Circle c4 = new Circle(3);
		...
		Circle c4 = new Circle(3, "yellow");
		Circle c5 = new Circle(3, "pink");
...
//		Collection<Circle> c=l;
//		Collection<Circle> c= new HashSet<Circle>(l);  //removing dublicates
//		Collection<Circle> c= new TreeSet<Circle>(l);  //removing dublicates
		Set<Circle> c= new TreeSet<Circle>(l);  //removing dublicates
...
//			System.out.println((Circle)l.get(i));
